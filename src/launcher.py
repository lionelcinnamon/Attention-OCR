...
if __name__ == "__main__":
    ...
    # need to change data_path and data base dir to absolute path
    # python src/launcher.py --phase=train --data-path=data/train.txt --data-base-dir=../data/printed --log-path=log.txt --model-dir=model --num-epoch=10 --batch-size=32 --target-vocab-size=14
    # python src/launcher.py --phase=test --data-path=/home/lionel/Desktop/ocr/Attention-OCR/data/val.txt --data-base-dir=/home/lionel/Desktop/ocr/data --log-path=log_test.txt --model-dir=model --num-epoch=20 --batch-size=16 --target-vocab-size=14 --gpu-id=0 --load-model --visualize=False
